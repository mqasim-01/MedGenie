...
export default function DoctorNavbar() {
  ...
  return (
    <>
  {/* Navbar */}
  <nav className="absolute top-0 left-0 w-full z-10 bg-gradient-to-r from-seablue-200 to-seablue flex flex-col md:flex-row md:items-center md:justify-between p-4">
