    ...
    <div className="leading-normal tracking-normal">
      <div className={`gradient bg-gradient-to-r from-seablue to-seablue-200 ${scrollNav ? 'bg-white' : ''}`}>
        ...
        <div className="relative -mt-12 lg:-mt-24 ">
          ...
          <svg className="wave-top shadow sha" viewBox="0 0 1439 147" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
          <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g transform="translate(-1.000000, -14.00000)" fillRule="nonzero">
      ...
      {isPopupOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div ref={popupRef} className="relative bg-white rounded-lg p-8 shadow-md">
            {popupType === 'signin' && (
              <>
